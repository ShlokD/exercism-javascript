var Triplet = require('../pythagorean-triplet/pythagorean-triplet.js').Triplet;
var where = require('../pythagorean-triplet/pythagorean-triplet.js').where;
...
describe('Triplet', function () {
  ...
  it('can make triplets up to 10', function () {
    var triplets = where({ maxFactor: 10 });
  ...
  it('can make triplets 11 through 20', function () {
    var triplets = where({ minFactor: 11, maxFactor: 20 });
    var products = triplets.sort().map(function (triplet) {
      return triplet.product();
    });
  ...
  it('can filter on sum', function () {
    var triplets = where({ sum: 180, maxFactor: 100 });
    var products = triplets.sort().map(function (triplet) {
      return triplet.product();
    });
