var circularBuffer = require('../circular-buffer/circular-buffer.js').circularBuffer;
var bufferEmptyException = require('../circular-buffer/circular-buffer.js').bufferEmptyException;
var bufferFullException = require('../circular-buffer/circular-buffer.js').bufferFullException;
...
describe('CircularBuffer', function () {
  ...
  it('clearing a buffer', function () {
    ...
    buffer.write('2');
    buffer.clear();
    expect(buffer.read).toThrowError; //eslint-disable-line
    buffer.write('3');
    buffer.write('4');
